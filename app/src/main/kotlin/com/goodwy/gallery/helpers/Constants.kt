...
fun getDefaultFileFilter() = TYPE_IMAGES or TYPE_VIDEOS or TYPE_GIFS or TYPE_RAWS or TYPE_SVGS or TYPE_PORTRAITS
...
const val GROUP_BY_LAST_MODIFIED_YEARLY = 4096
const val GROUP_BY_DATE_TAKEN_YEARLY = 8192
const val GROUP_BY_LAST_MODIFIED_NONE = 16384
const val GROUP_BY_DATE_TAKEN_NONE = 32768
const val GROUP_BY_OTHER_NONE = 65536
