...
class PlaybackSpeedFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        val background = ResourcesCompat.getDrawable(resources, com.goodwy.commons.R.drawable.bottom_sheet_bg, requireContext().theme)
        ...
        binding.apply {
            ...
            playbackSpeedX050.background.applyColorFilter(requireContext().getProperPrimaryColor())
            playbackSpeedX100.background.applyColorFilter(requireContext().getProperPrimaryColor())
            playbackSpeedX150.background.applyColorFilter(requireContext().getProperPrimaryColor())
            playbackSpeedX050.setOnClickListener { seekBar!!.progress = HALF_PROGRESS - 105 }
            playbackSpeedX100.setOnClickListener { seekBar!!.progress = HALF_PROGRESS }
            playbackSpeedX150.setOnClickListener { seekBar!!.progress = HALF_PROGRESS + 40 }
