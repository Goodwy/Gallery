...
import com.goodwy.gallery.databinding.ActivityPanoramaVideoBinding
import com.goodwy.gallery.extensions.config
import com.goodwy.gallery.extensions.hasNavBar
import com.goodwy.gallery.extensions.hideSystemUI
import com.goodwy.gallery.extensions.showSystemUI
import com.goodwy.gallery.helpers.MIN_SKIP_LENGTH
                ...
                setEventListener(object : VrVideoEventListener() {
                    ...
                    override fun onLoadSuccess() {
                        ...
                        if (mPlayOnReady || config.autoplayVideos) {
                            ...
                            binding.bottomVideoTimeHolder.videoTogglePlayPause.setImageResource(com.goodwy.commons.R.drawable.ic_play_outline_vector)
                        }
//                        binding.bottomVideoTimeHolder.videoTogglePlayPause.beVisible()
    ...
    private fun resumeVideo() {
        binding.bottomVideoTimeHolder.videoTogglePlayPause.setImageResource(com.goodwy.commons.R.drawable.ic_pause_outline_vector)
    ...
    private fun setupButtons() {
        ...
        binding.bottomVideoTimeHolder.root.onGlobalLayout {
            val newBottomMargin = binding.bottomVideoTimeHolder.root.height - resources.getDimension(R.dimen.video_player_play_pause_size)
                .toInt() - resources.getDimension(com.goodwy.commons.R.dimen.activity_margin).toInt()
