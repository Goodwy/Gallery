...
import com.goodwy.gallery.App.Companion.isProVersion
...
class SettingsActivity : SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateMaterialActivityViews(settings_coordinator, settings_holder, false)
        setupMaterialScrollListener(settings_scrollview, settings_toolbar)
    ...
    private fun setupSettingItems() {
        ...
        arrayOf(
            ...
            it.background.applyColorFilter(getBottomNavigationBackgroundColor())//getProperBackgroundColor().getContrastColor()
        }

        arrayOf(
            settings_customize_colors_chevron,
            settings_manage_included_folders_chevron,
            settings_manage_excluded_folders_chevron,
            settings_manage_hidden_folders_chevron,
            settings_change_date_time_format_chevron,
            settings_file_thumbnail_style_label_chevron,
            settings_manage_extended_details_chevron,
            settings_manage_bottom_actions_chevron,
            settings_export_chevron,
            settings_import_chevron,
        ...
        divider_other.setBackgroundColor(getProperTextColor())
    }
    ...
    private fun setupCustomizeColors() {
        ...
        settings_customize_colors_label.text = if (isProVersion()) {
        ...
        settings_customize_colors_holder.setOnClickListener {
            ...
            /*if (isProVersion()) {
                startCustomizationActivity(false, isProVersion(), BuildConfig.GOOGLE_PLAY_LICENSING_KEY, BuildConfig.PRODUCT_ID_X1, BuildConfig.PRODUCT_ID_X2, BuildConfig.PRODUCT_ID_X3)
            } else {
                launchPurchase()
            }*/
            startCustomizationActivity(false, isProVersion(), BuildConfig.GOOGLE_PLAY_LICENSING_KEY, BuildConfig.PRODUCT_ID_X1, BuildConfig.PRODUCT_ID_X2, BuildConfig.PRODUCT_ID_X3)
    ...
    private fun setupTransparentBottomNavigationBar() {
        settings_transparent_navigation_bar.isChecked = config.transparentNavigationBar
        settings_transparent_navigation_bar_holder.setOnClickListener {
            settings_transparent_navigation_bar.toggle()
            config.transparentNavigationBar = settings_transparent_navigation_bar.isChecked
            Timer().schedule(200){
                exitProcess(0)
            }
        }
    ...
    private fun setupChangeDateTimeFormat() {
        //if (settings_language_holder.isGone() && settings_use_english_holder.isGone()) settings_change_date_time_format_holder.setBackgroundResource(R.drawable.ripple_bottom_corners)
    ...
    private fun setupUseEnglish() {
        ...
        //if (settings_language_holder.isGone()) settings_use_english_holder.setBackgroundResource(R.drawable.ripple_bottom_corners)
    ...
    private fun setupManageIncludedFolders() {
        ...
        settings_manage_included_folders_size.text = config.includedFolders.size.toString()
    }
    ...
    private fun setupManageExcludedFolders() {
        ...
        settings_manage_excluded_folders_size.text = config.excludedFolders.size.toString()
    }
    ...
    private fun setupManageHiddenFolders() {
        ...
        getNoMediaFolders {
            runOnUiThread {
                settings_manage_hidden_folders_size.text = it.size.toString()
            }
        }
    }
    ...
    private fun setupExportSettings() {
        settings_export_holder.setOnClickListener {
            val configItems = LinkedHashMap<String, Any>().apply {
                ...
                put(TRANSPARENT_NAVI_BAR, config.transparentNavigationBar)
    ...
    private fun setupTipJar() {
        settings_tip_jar_holder.beVisibleIf(isProVersion())
